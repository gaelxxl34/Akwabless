...
const Registration = ({ setopenJoin }: Props) => {
  ...
  return (
    <div className="max-w-6xl w-full flex shadow-lg rounded-lg overflow-hidden">
      ...
      <div className="w-2/5 bg-gradient-to-br from-[#D4AF37] to-yellow-600 p-10 flex flex-col">
        <div
      ...
      <div className="w-3/5 bg-white p-10">
        ...
        {/* <div className="bg-yellow-50 border-l-4 border-yellow-500 p-4 mb-6 flex items-start">
