...
import { text } from "../../libs/data/directorContentData";
      ...
      >
        ...
        <nav className="mt-6 px-4">
          <div className="space-y-2">
            ...
            <Link to="/director/brochure-generator">
              <button
